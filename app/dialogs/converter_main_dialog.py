...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QtWidgets.QWidget(self.EditFileTab)
        self.widget.setGeometry(QtCore.QRect(540, 10, 91, 61))
        self.widget.setObjectName("widget")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.FileFormatLabel = QtWidgets.QLabel(self.widget)
        self.FileFormatLabel.setObjectName("FileFormatLabel")
        self.verticalLayout_3.addWidget(self.FileFormatLabel)
        self.FormatBox = QtWidgets.QComboBox(self.widget)
        self.FormatBox.setObjectName("FormatBox")
        self.verticalLayout_3.addWidget(self.FormatBox)
        self.widget1 = QtWidgets.QWidget(self.EditFileTab)
        self.widget1.setGeometry(QtCore.QRect(40, 10, 461, 191))
        self.widget1.setObjectName("widget1")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget1)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.FilesList = QtWidgets.QListWidget(self.widget1)
        ...
        self.ChooseFilesButton = QtWidgets.QPushButton(self.widget1)
        self.ChooseFilesButton.setObjectName("ChooseFilesButton")
        self.horizontalLayout_2.addWidget(self.ChooseFilesButton)
        self.ConvertButton = QtWidgets.QPushButton(self.widget1)
