...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_9.addWidget(self.AddToITunesBox)
        self.PlayerLoadingLabel = QtWidgets.QLabel(self.DownloadTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.PlayerLoadingLabel.sizePolicy().hasHeightForWidth())
        self.PlayerLoadingLabel.setSizePolicy(sizePolicy)
        self.PlayerLoadingLabel.setMinimumSize(QtCore.QSize(150, 0))
        self.PlayerLoadingLabel.setText("")
        self.PlayerLoadingLabel.setObjectName("PlayerLoadingLabel")
        self.horizontalLayout_9.addWidget(self.PlayerLoadingLabel, 0, QtCore.Qt.AlignRight)
