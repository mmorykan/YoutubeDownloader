...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 671, 301))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(500, 0, 258, 211))
        ...
        self.AudioAndVideoBox = QtWidgets.QCheckBox(self.layoutWidget)
        self.AudioAndVideoBox.setObjectName("AudioAndVideoBox")
        self.verticalLayout.addWidget(self.AudioAndVideoBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AudioAndVideoBox.setText(_translate("MainWindow", "Keep Video"))
