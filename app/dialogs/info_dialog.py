...
class Ui_InfoDialog(object):
    def setupUi(self, InfoDialog):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 611, 277))
    ...
    def retranslateUi(self, InfoDialog):
        ...
        self.label.setText(_translate("InfoDialog", "Keep Original: Saves the originally downloaded file before the conversion to your specified format"))
        self.label_2.setText(_translate("InfoDialog", "Keep Trimmed Original: Same as Keep Original with trimming applied to the original file"))
        self.label_3.setText(_translate("InfoDialog", "Keep Video: Downloads the video as well as the audio if specified format supports video"))
